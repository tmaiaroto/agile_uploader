<html>
<head>
	<title>Agile Uploader - Multiple Image Upload Demo</title>
	...
	<script src="agile-uploader-2.0.js" type="text/javascript"></script>
...
<p><a href="#" onClick="document.getElementById('agileUploaderSWF').sendForm();">Submit</a></p>
</div>
    ...
    <script type="text/javascript">
    	$('#multiple').agileUploader({
    		...
    		formId: 'multipleDemo',
    		flashVars: {
    			form_action: '/agile-uploader/examples/process.php',
    			file_limit: 3,
